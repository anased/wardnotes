// src/components/debug/RlsFixer.tsx
import { useState } from 'react';
import Button from '@/components/ui/Button';
import { supabase } from '@/lib/supabase/client';

export default function RlsFixer() {
  ...
  return (
    <div className="p-4 border border-gray-300 rounded-lg dark:border-gray-700 bg-white dark:bg-gray-800">
      <h2 className="text-lg font-semibold mb-4">RLS Policy Fixer</h2>
      <p className="mb-4 text-gray-600 dark:text-gray-400">
        This tool will attempt to fix the Row-Level Security policy issue by testing different insertion approaches.
      </p>
      
      <Button onClick={runFix} isLoading={loading}>
        Fix RLS Policy
      </Button>
